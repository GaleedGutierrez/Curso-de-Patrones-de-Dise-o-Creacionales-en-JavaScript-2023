...
class BaseCar {
	 ...
	 * @param {string} edition.edition edition.edition
	 * @param {string} edition edition of car like cvt/signature
	 * @param {string} model car model like sedan/hatchback
	 * @param {number} airBags number of car air bags
	 * @param {string} color car color
	 * @param {string} edition.model edition.model
	 * @param {number} edition.airBags edition.airBags
	 * @param {string} edition.color edition.color
	 */
	...
	/**
	 * Abstract method to be implemented by all the classes
...
class MastodonSedanCar extends BaseCar {
	 ...
	 * @param {MastodonSedanCar} carToClone instance of MastodonSedanCar
	 */
	...
	/**
	 * @override
	 * @returns {MastodonSedanCar} a mastodon sedan car configured as the original
	 */
	clone() {
...
class SedanProductionLine extends CarProductionLine {
	 ...
	 *creating.
	 *
	 *In builder.ts the production line was "composed" by the car to
	 ...
	 * @override
	 * @param {string} edition car edition
	 * @returns {this} production line working instance
	 */
	setEdition(edition) {
