 ...
 * just to be more explicit we declare both production line classes.
 */
...
class BaseCar {
	 ...
	 * @param model - car model (sedan/hatchback)
	 */
...
export class Director {
	#productionLine!: CarProductionLine;
	...
	constructSportEdition() {
		this.productionLine.setAirBags(4).setColor('gray').setEdition('sport');
	}
